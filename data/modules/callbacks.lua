...
local m_onOpcodeArgs = { }
function onOpcode(player, opcode, msg)
  m_onOpcodeArgs.creature = player
  m_onOpcodeArgs.opcode = opcode
  m_onOpcodeArgs.msg = msg
  return Signal.emit("onOpcode", m_onOpcodeArgs)
end
